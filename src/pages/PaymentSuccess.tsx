            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="font-medium">Confirmación del vendedor</p>
                    <p className="text-muted-foreground">El vendedor confirmará la disponibilidad del producto</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="font-medium">Preparación del envío</p>
                    <p className="text-muted-foreground">El producto será preparado para el envío</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 bg-muted text-muted-foreground rounded-full flex items-center justify-center text-xs font-bold">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Recibirás el tracking una vez enviado</p>
                  </div>
                </div>
              </div>
            </CardContent>
